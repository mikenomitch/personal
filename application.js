...
var projects = [{name:"TeachingTree",header:"TeachingTree",tools: ["Ruby","RubyonRails","HTML5","CSS3","SCSS","Git","Heroku","Javascript","JQuery","Ajax","JQuery","D3", "postgres"], div: "<a href='http://www.teachingtree.co' target='_top'>TeachingTree</a> is an online platform for people who want quick access to concepts in Computer Science and Math lectures. Any user can add videos and time-stamped tags to help other students. </br></br> The site has over 1500 users and has been featured on <a href='http://www.code.org/learn/scratch' target='_top'>Code.org</a>, <a href='http://tech.co/teachingtree-online-learning-2013-04' target='_top'>Tech Cocktail</a>, and <a href='http://www.freetech4teachers.com/2013/02/teaching-tree-video-explanations-of.html' target='_top'>various</a> <a href='http://www.educatorstechnology.com/2013/05/teaching-platform-for-computer-and-math.html' target='_top'>other</a> <a href='http://www.freetech4teachers.com/2013/02/teaching-tree-video-explanations-of.html' target='_top'>blogs</a>. </br></br> Development on the site began in November 2012 and it is written using Ruby on Rails."},
                {name:"Two_cents",header:"Two Cents", tools: ["Ruby","RubyonRails","HTML5","CSS3","Git","Heroku","Javascript","Coffeescript","JQuery","Ajax","JQuery", "Backbone", "postgres"], div: "<a href='http://curated.herokuapp.com/' target='_top'>Two Cents</a> began as a weekend project, but has grown over time. The site allow users to post stylized 'micro-reviews' of songs and albums with embedded links to YouTube, Spotify, and SoundCloud. </br></br> It was primarily written over the span of two weeks using Ruby on Rails and Backbone. Feel free to check out the source code on <a href='https://github.com/mikenomitch/curated' target='_top'>GitHub</a>."},
...
var tools = [{name:"Ruby",projects:["TeachingTree","Two_cents","Find_by_shortcut"],div:"Ruby was used to create the back-end of TeachingTree and Two Cents (both of which use Rails). Additionally I used it to write Find_by_shortcut, which is a Ruby gem that uses light metaprogramming in order to make Active Record queries easier. </br></br> The more I get into Javascipt, the more I find myself appreciating just how good Ruby is."},
             ...
             {name:"postgres",projects:["TeachingTree","Two_cents"],div:"postgres"},
