...
function toMike(){
  ...
  $("#relevant_info_text").html("I founded and develop <a href='www.teachingtree.co'>TeachingTree</a>, an online platform for easily accessing concepts within college-level math and computer science lectures. I also recently launched <a href='curated.herokuapp.com'>TwoCents</a>, a simple way to quickly share your thoughts on music with friends.</br></br>Click each project for more information or check out my <a href='http://www.linkedin.com/pub/michael-nomitch/45/474/3b5/'>LinkedIn</a> and <a href='https://github.com/mikenomitch/'>GitHub</a> pages.</br></br>I like bad martial arts movies, playing eight-ball, and setting screens in pickup games.");
  clicked_val = "mike";
}
...
var projects = [{name:"TeachingTree",header:"TeachingTree",tools: ["Ruby","RubyonRails","HTML5","CSS3","SCSS","Git","Heroku","Javascript","JQuery","Ajax","JQuery","D3"], div: "<a href='www.teachingtree.co'>TeachingTree</a> is an online platform for people who quick access to concepts in Computer Science and Math lectures. The platform allows any user to add videos and time-stamped tags for other students. </br></br> The site has over 1500 users and has been featured on <a href='http://www.code.org/learn/scratch'>Code.org</a>, <a href='http://tech.co/teachingtree-online-learning-2013-04'>Tech Cocktail</a>, and <a href='http://www.freetech4teachers.com/2013/02/teaching-tree-video-explanations-of.html'>various</a> <a href='http://www.educatorstechnology.com/2013/05/teaching-platform-for-computer-and-math.html'>other</a> <a href='http://www.freetech4teachers.com/2013/02/teaching-tree-video-explanations-of.html'>blogs</a>. </br></br> Development on the site began in November 2012 and it is written using Ruby on Rails."},
                {name:"Two_cents",header:"Two Cents", tools: ["Ruby","RubyonRails","HTML5","CSS3","Git","Heroku","Javascript","Coffeescript","JQuery","Ajax","JQuery", "Backbone"], div: "<a href='http://curated.herokuapp.com/'>Two Cents</a> began as a weekend project, but has grown over time. It allows users to post stylized 'micro-reviews' of songs and albums with embedded links to YouTube, Spotify, and SoundCloud. </br></br> It was written over the span of two weeks using Ruby on Rails and Backbone. Feel free to check out the source code on <a href='https://github.com/mikenomitch/curated'>GitHub</a>."},
                {name:"Find_by_shortcut",header:"find_by_shortcut", tools: ["Ruby", "RubyonRails"], div: "Find_by_shortcut is a Ruby Gem that was created to make the Rails Console a bit simpler. It modifies Active Record to allow for shorcuts while searching through your database. </br></br> Check out <a href='https://github.com/mikenomitch/find_by_shortcut'>the documentatipn on GitHub</a> for more info."},
                {name:"Griddy_city",header:"Griddy City", tools: ["HTML5", "CSS3", "Javascript"], div: "Griddy City is a simple game that I created using Javascript to help my friends get to know the grid system of Chicago better. </br></br> It is by far my proudest achievement (just kidding - I wrote it in a few hours). </br></br> It is on <a href='https://github.com/mikenomitch/griddy'>GitHub</a>."}]
